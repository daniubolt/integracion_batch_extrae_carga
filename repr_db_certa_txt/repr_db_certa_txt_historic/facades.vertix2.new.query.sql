...
inner join smBlockGeo g1 on b.blockId = g1.blockId and blockverini>blockverend and (g1.blockgeoorder =  blockverini or g1.blockgeoorder <= blockverend) 
where (logIdFrom > $logIdSyncMin and logIdFrom <= $logIdSyncMax) or (logIdTo > $logIdSyncMin and logIdTo <= $logIdSyncMax) 
order by logIdFrom, f.blockFacadeId, g1.blockgeoorder desc