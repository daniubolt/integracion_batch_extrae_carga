...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "SMBLOCKFACADES_INSERT" 
...
END;
/
ALTER TRIGGER "SMBLOCKFACADES_INSERT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger SMBLOCKFACADES_UPDATE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SMBLOCKFACADES_UPDATE" 
...
END;
/
ALTER TRIGGER "SMBLOCKFACADES_UPDATE" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "SPRENTITIES_DELETE" 
...
END;
/
ALTER TRIGGER "SPRENTITIES_DELETE" ENABLE;
--------------------------------------------------------
--  DDL for Trigger SPRENTITIES_INSERT
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SPRENTITIES_INSERT" 
...
END;
/
ALTER TRIGGER "SPRENTITIES_INSERT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger SPRENTITIES_UPDATE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SPRENTITIES_UPDATE" 
...
END;
/
ALTER TRIGGER "SPRENTITIES_UPDATE" ENABLE;
--------------------------------------------------------
